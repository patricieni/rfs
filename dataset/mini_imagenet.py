...
class ImageNet(Dataset):
    def __init__(self,
        ...
        # Feel like some things are wrong in here, in particular the Image.fromarray, then converting back to array.
        # Should use Image.open() in get_item
        ...
        # Why load the data in here..from pickle?
        # reading needs to happen on the fly in the get_item method
        self.data = {}
...
class MetaImageNet(ImageNet):
    def __init__(self,
                 ...
                 test_transform=None,
                 fix_seed=True):
        super(MetaImageNet, self).__init__(args, partition, pretrain=False)
...
if __name__ == '__main__':
    ...
    # This was wrong without the partition argument test/val,
    # but I guess it is just to test it works as expected.
    metaimagenet = MetaImageNet(args, 'test')
